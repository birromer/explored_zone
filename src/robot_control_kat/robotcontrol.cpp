...
RobotControl::RobotControl()
{
	...
	//setRobotToPosition(48.4016736602,-4.5192572275, 0);
	//Q_EMIT drawCircleSignal(QGeoCoordinate(48.40167366,-4.5192572),0.75,pointTraceName,"brown");
	...
	std::ifstream infile("/home/robot/ros/converti2.txt");
	double lon0, lat0, lon1, lat1, lon2, lat2, lon3, lat3, lon4, lat4, col10, col11;
    while (infile >> lon0 >> lat0 >> lon1 >> lat1 >> lon2 >> lat2 >> lon3 >> lat3 >> lon4 >> lat4 >> col10 >> col11)
    //for (int i=0;i<15;i++)
    {
    /*infile >> lon0 >> lat0 >> lon1 >> lat1 >> lon2 >> lat2 >> lon3 >> lat3 >> lon4 >> lat4 >> col10 >> col11;
    infile >> lon0 >> lat0 >> lon1 >> lat1 >> lon2 >> lat2 >> lon3 >> lat3 >> lon4 >> lat4 >> col10 >> col11;
    infile >> lon0 >> lat0 >> lon1 >> lat1 >> lon2 >> lat2 >> lon3 >> lat3 >> lon4 >> lat4 >> col10 >> col11;
    infile >> lon0 >> lat0 >> lon1 >> lat1 >> lon2 >> lat2 >> lon3 >> lat3 >> lon4 >> lat4 >> col10 >> col11;*/
    Q_EMIT drawCircleSignal(QGeoCoordinate(col11, col10),1,"kat","green");
    
	/*Q_EMIT drawLineSignal(QGeoCoordinate(lat0,lon0),QGeoCoordinate(lat1,lon1),2,"katline","blue");
	Q_EMIT drawLineSignal(QGeoCoordinate(lat1,lon1),QGeoCoordinate(lat2,lon2),2,"katline","blue");
	Q_EMIT drawLineSignal(QGeoCoordinate(lat2,lon2),QGeoCoordinate(lat3,lon3),2,"katline","blue");
	Q_EMIT drawLineSignal(QGeoCoordinate(lat3,lon3),QGeoCoordinate(lat4,lon4),2,"katline","blue");*/
    }
        
	//test qui marche: affichage d'un point à une certaine coordonnée
	//Q_EMIT drawCircleSignal(QGeoCoordinate(48.202037,-3.016226),3,"kat","blue");
	//Q_EMIT drawLineSignal(QGeoCoordinate(48.202244, -3.016137),QGeoCoordinate(48.202235, -3.016344),3,"katline","blue");
	//Q_EMIT drawLineSignal(QGeoCoordinate(48.202391, -3.016515),QGeoCoordinate(48.202235, -3.016344),3,"katline","blue");
	//Q_EMIT drawLineSignal(QGeoCoordinate(48.202391, -3.016515),QGeoCoordinate(48.202405, -3.016024),3,"katline","blue");
	//Q_EMIT drawLineSignal(QGeoCoordinate(48.202244, -3.016137),QGeoCoordinate(48.202405, -3.016024),3,"katline","blue");
